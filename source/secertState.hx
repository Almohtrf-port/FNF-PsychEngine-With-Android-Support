...
class secertState extends MusicBeatState
{
	...
	override function create()
	{
		...
		if (FlxG.sound.music != null)
		{
			...
			FlxG.sound.playMusic(Paths.music('secert'), 0);
		}	

		 #if desktop
		 // Updating Discord Rich Presence
		 DiscordClient.changePresence("In secert menu ", null);
		 #end
		...
		isDebug = true;
			...
			//addWeek(['smart-bars'], 1, ['Smart-kat']);
		...
		var bg:FlxSprite = new FlxSprite(-1300, -90).loadGraphic(Paths.image('othermenu'));
		add(bg);
